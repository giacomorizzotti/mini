...
function consentGranted() {
    ...
    //console.log("Cookie consent: Yes");
...
function consentDenied() {
    ...
    eraseCookie('_ga');
    eraseCookie('_gat_gtag_'+(analyticsCode.substring(1)) );
    eraseCookie('_ga_'+(analyticsCode.substring(1)) );
    eraseCookie('_gat_gtag_'+(analyticsCode.substring(2)) );
    eraseCookie('_ga_'+(analyticsCode.substring(2)) );
    eraseCookie('_gid');
    setCookie('consent_banner', 'no', '30', "/", "");

    //console.log("Cookie consent: No");
...
window.addEventListener("load", cookieConstentStatus());
